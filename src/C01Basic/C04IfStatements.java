...
//        else System.out.println("walk");
        ...
        // if 문을 독립적으로 따로 두고 싶은 경우엔 정확한 범위를 지정해줘야 함.

        // 삼항 연산자 : 결과값 = 조건식? 반환값21:반환값2
//        String answer = "1234";
//        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
//        String input = br.readLine();
//        String result = answer.equals(input) ? "open" : "closed";
//        System.out.println(result);

        // switch 문: if, else if, else if 문이 있을 때 가독성 있게 표현한 구문
